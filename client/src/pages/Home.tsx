...
export default function Home() {
  const { user } = useAuth();
  const { setCurrentTrack, isFavorite, toggleFavorite: toggleFavoriteLocal } = usePlayer();
  ...
  }, [searchQuery, searchYouTubeMutation, searchSoundCloudMutation]);
  ...
  }, [user, saveTrackMutation, setCurrentTrack]);
